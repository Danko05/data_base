...
class Cinema_has_viewer(db.Model, IDto):
    """
    Model declaration for Data Mapper.
    """
    __tablename__ = "cinema_has_viewer"
    ...
    def __repr__(self) -> str:
        return f"Facts({self.id},'{self.cinema_id}', '{self.viewer_id}')"
    ...
    @staticmethod
    def create_from_dto(dto_dict: Dict[str, Any]) -> Cinema_has_viewer:
        """
        Creates domain object from DTO
        :param dto_dict: DTO object
        :return: Domain object
        """
        obj = Cinema_has_viewer(
            id=dto_dict.get("id"),
